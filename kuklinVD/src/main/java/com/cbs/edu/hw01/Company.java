...
public class Company {
    public static void main(String[] args) {
        ...
        googleProjectSprintFirst.endPhaseDate = "27.03.18";
        ...
        facebookProjectSprintFirst.endPhaseDate = "02.11.18";
        ...
        appleProjectSprintFirst.endPhaseDate = "05.06.19";
        ...
        teslaProjectSprintFirst.endPhaseDate = "15.04.20";
        ...
        microsoftProjectSprintFirst.endPhaseDate = "14.12.20";
        Sprint microsoftProjectSprintSecond = new Sprint();
        microsoftProjectSprintSecond.endPhaseDate = "10.02.21";
